...
: ${AMENT_CURRENT_PREFIX:="/mnt/d/realsense-pub-interface/realsense_processor/install/realsense_processor"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/realsense_processor/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/realsense_processor/environment/path.sh"
